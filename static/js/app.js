...
const translations = {
  en: {
    ...
    vaultDepositBtn: "Deposit to Vault",
    vaultUploading: "Uploading...",
    vaultEnterCode: "Enter 8-digit pickup code",
    vaultCodePlaceholder: "A1B2C3D4",
    ...
    vaultErrorCodeLen: "Please enter 8-digit code (letters and numbers)",
  ...
  zh: {
    ...
    vaultDepositBtn: "存入保险箱",
    vaultUploading: "上传中...",
    vaultEnterCode: "输入 8 位收件码",
    vaultCodePlaceholder: "A1B2C3D4",
    ...
    vaultErrorCodeLen: "请输入 8 位收件码（字母和数字）",
